...
class EpisodesController extends Controller
{
    ...
    public function getEpisodeAction($idEpisode, Request $request)
    {
        ...
        if ($request->getRequestFormat() === "html") {
            ...
            if (isset($renderData['links'][0])) {
                $renderData['links'] = $renderData['links'][0];
            }
    ...
    public function getLinksAction(Request $request)
    {
        ...
        if ($request->getRequestFormat() === "html") {
            ...
            foreach ($links as $linkInfo) {
                $data["payload"]["episodes"][] = $this->convertLinks2Array($linkInfo);
            }
    ...
    public function getDirectLinkAction($idLink, Request $request)
    {
        ...
        $data["payload"]["episodes"][] = $this->convertLinks2Array($links);
    ...
    public function convertLinks2Array(AnimesLinks $linkInfo)
    {
        return array(
            "id" => $linkInfo->getId(),
